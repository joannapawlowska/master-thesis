...
\begin{thebibliography}{20}
    ...
    \bibitem{classification-problem-decision-trees} Ashima Gambhir. Classification Problem in Data Mining Using Decision Trees. LAP LAMBERT Academic Publishing, 2019.
    ...
    \bibitem{introduction-to-parallel-computing} Grama, A., Anshul Gupta, A., George Karypis, G. \& Kumar, V. Introduction to Parallel Computing. Addison-Wesley Professional, 2003.
    ...
    \bibitem{java-concurency-in-practice} Goetz, B., Peierls, T., Bloch, J., Bowbeer, J., Holmes, D. \& Lea, D. Java Concurrency in Practice. Addison - Wesley, 2006.
    \bibitem{concurrent-programming} Lea, D. Concurrent Programming in Java: Design Principles and Pattern, 2nd Edition. Addision-Wesley, 2000.
    \bibitem{the-art-of-multiprocessor-programming} Herlihy, M., \& Shavit, N. The Art of Multiprocessor Programming, Revised Reprint. Morgan Kaufmann, 2012.
    \bibitem{java-memeory-management} Maaike van Putten \& Seán Kennedy. Java Memory Management. Packt Publishing, 2022.
    \bibitem{java-threads} Oaks, S., \& Wong, H. Java Threads: Understanding and Mastering Concurrent Programming. O'Reilly, 2004.
    \bibitem{data-visualisation-in-python} Nelson, D. Data Visualization in Python. Stack Abuse, 2021.
    \bibitem{python-for-data-analysis} McKinney, W. Python for Data Analysis: Data Wrangling with Pandas, NumPy, and IPython. O'Reilly, 2018.
    \bibitem{linux-command-line} Blum, R., \& Bresnahan, C. (Author). Linux Command Line and Shell Scripting Bible 4th Edition. Wiley, 2021.
    \bibitem{learining-bash} Newham C. Learning the bash Shell: Unix Shell Programming. O'Reilly, 2005.
