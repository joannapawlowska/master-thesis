...
W rozdziale zawarty jest też opis programu stworzonego w języku Java, który umożliwia uruchamianie algorytmu we wszystkich trzech wersjach.
...
\begin{itemize}
    ...
    \item \verb|--train-ratio| -- udział procentowy danych losowo wybieranych do zbioru treningowego,
...
\begin{lstlisting}[caption=Przykładowe uruchomienie programu w wersji sekwencyjnej]
